    ...
    return Scaffold(
      ...
      bottomNavigationBar: SizedBox(
        ...
        child: Row(
          ...
          children: [
            FormHelper.submitButton('Ajouter',() {
              if (validateAndSave()){
  ...
  _formUI () {
    return SingleChildScrollView(
      child: Padding(
        ...
        child: Column(
          children: [
            FormHelper.inputFieldWidgetWithLabel(context, "nom", "Nom", "", (onValidate) {
              if(onValidate.isEmpty) {return "* Required";} return null;
            }, (onSaved){
            ...
            FormHelper.inputFieldWidgetWithLabel(context, "telephone", "Téléphone", "", (onValidate){
              if(onValidate.isEmpty) {return "* Required";} return null;
            } , (onSaved){
